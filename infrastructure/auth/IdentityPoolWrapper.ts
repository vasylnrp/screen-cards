...
export class IdentityPoolWrapper {
  ...
  constructor (scope: Construct, userPool: UserPool, userPoolClient: UserPoolClient, cardsBucketArn: string) {
    this.scope = scope;
    this.userPool = userPool;
    this.userPoolClient = userPoolClient;
    this.cardsBucketArn = cardsBucketArn;
    this.initialize();
  }
  ...
  private initializeIdentityPool() {
    this.identityPool = new CfnIdentityPool(this.scope, 'ScreenCardsIdentityPool', {
